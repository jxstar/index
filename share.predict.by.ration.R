...
index=index[which(index$Date==as.Date("2014-02-10")):which(index$Date==as.Date("2015-05-10")),]
date=index$Date
test=date-c(date[1],date[-length(date)])
test
...
legend("bottomleft",legend=c("baidu ", "qihu ", "sogou"),pch=c(1,1,1),col=mycolor[c(1,2,4)])
...
# use the definite flow quantity instead of hotword index
  ...
  mycolor=rainbow(10)
  plot(uvpv$date,uvpv$bpv,type="p",cex=0.3,col=mycolor[1],lty=1,ylim=c( 1258812, 892000000))
  legend("bottomleft",legend=c("baidu pv", "qihu pv", "sogou pv"),pch=c(1,1,1),col=mycolor[c(1,2,4)])
  lines(uvpv$date,uvpv$qpv,type="p",cex=0.3,col=mycolor[2],lty=4)
  lines(uvpv$date,uvpv$spv,type="p",cex=0.3,col=mycolor[4],lty=2)

  
  plot(uvpv$date,uvpv$buv,type="b",col=mycolor[1],lty=1,ylim=c( 0, 100000000))
  legend("bottomleft",legend=c("baidu uv", "qihu uv", "sogou uv"),lty=c(1,2,4),col=mycolor[c(1,2,4)])
  lines(uvpv$date,uvpv$quv,type="b",col=mycolor[2],lty=4)
  lines(uvpv$date,uvpv$suv,type="b",col=mycolor[4],lty=2)
